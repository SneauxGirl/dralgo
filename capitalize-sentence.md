...
// ===== Example Problem =====
```
Given a string of words (a sentence), return a new string where the first letter of each word is capitalized.
```
// ===== Clarifying Questions =====

- What should be done if there are mutiple spaces between words?
- Are puncutation marks included in words?

// ===== TestCase =====
```
console.log(capitalizeSentence("if i were a rich man"));
```
